...
{
    public class nfe_saida1Map : EntityTypeConfiguration<nfe_saida1>
    {
        public nfe_saida1Map()
        {
            // Primary Key
            this.HasKey(t => new { t.nu_cnpjEmpresa, t.nu_cnpjCpfFornecedor, t.nu_chave, t.dt_emissao, t.nu_nf, t.dt_cadastro, t.ds_protocolo, t.fl_statusInportacao, t.fl_status });
            ...
            this.Property(t => t.fl_status)
                .HasDatabaseGeneratedOption(DatabaseGeneratedOption.None);

            // Table & Column Mappings
            this.ToTable("nfe_saida");
